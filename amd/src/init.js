define(['jquery', 'tool_datatables/jquery.dataTables', 'core/log',
	'tool_datatables/dataTables.bootstrap', 'tool_datatables/dataTables.select',
	'tool_datatables/dataTables.buttons', 'tool_datatables/buttons.bootstrap'],
       function ($, datatables) {
	   return {
	       test: function() {
